        ...
        <div class="max-w-md mx-auto md:px-8 sm:px-5 px-3 rounded-md shadow-md">
            ...
            <form action="#" method="post" ref={form} onSubmit={sendEmail}>
                <div class="mb-6 ">
                    ...
                    <input type="text" id="name" placeholder='Name' name="user_name" class="w-full px-3 py-2  rounded-md   bg-slate-700  focus:ring focus:ring-sky-400 focus:outline-none text-white"/>
                </div>
                <div class="mb-6"> 
                    {/* <label for="email" class="text-gray-600">Email</label> */}
                    <input type="email" id="email" placeholder='email' name="user_email" class="w-full px-3 py-2  rounded-md bg-slate-700 focus:ring focus:ring-sky-400 focus:outline-none text-white"/>
                </div>
                <div class="mb-6">
                    {/* <label for="message" class="text-gray-600">Message</label> */}
                    <textarea id="message" placeholder='message' name="message" rows="4" class="w-full px-3 py-2  rounded-md bg-slate-700 focus:ring focus:ring-sky-400 focus:outline-none text-white"></textarea>
                </div>
